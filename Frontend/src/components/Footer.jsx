    ...
    <div className="text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32">
      <div className="flex flex-wrap justify-between gap-12 md:gap-6">
        <div className="max-w-80">
          ...
          <p className="text-sm">
            Great products delivered to your door — same day. Quality you can
            trust, savings you&rsquo;ll love.
          </p>
        ...
        <div>
          ...
          <ul className="mt-3 flex flex-col gap-2 text-sm">
            ...
            <li>
              <a href="/safety" target="_blank" rel="noopener noreferrer">Safety Information</a>
            </li>
            <li>
              <a href="/cancellation" target="_blank" rel="noopener noreferrer">Cancellation Option</a>
            </li>
            <li>
              <a href="/customer-desk" target="_blank" rel="noopener noreferrer">Customer Desk</a>
            </li>
          </ul>
        </div>
        ...
        <div className="max-w-80">
          ...
          <form onSubmit={handleSubscribe} className="flex items-center justify-start mt-4">
            <input
              type="email"
              value={email}
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex items-center justify-center bg-black h-9 w-9 aspect-square rounded-r disabled:opacity-50"
            >
              <svg
      ...
      <div className="flex items-center justify-center py-5">
        <p className="text-center">© {new Date().getFullYear()} GoCart. All rights reserved.</p>
      </div>
    </div>
  );
};
