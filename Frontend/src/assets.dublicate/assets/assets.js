...
import custom_yoga_mat from "./custom_yoga_mat.png";
import custom_dumbbell from "./custom_dumbbell.png";
import custom_cycling_helmet from "./custom_cycling_helmet.png";
import custom_badminton_racket from "./custom_badminton_racket.png";
import custom_water_bottle from "./custom_water_bottle.png";
import custom_speaker from "./custom_speaker.png";
import custom_headphones from "./custom_headphones.png";
import custom_tv_42 from "./custom_tv_42.png";
import custom_gaming_laptop from "./custom_gaming_laptop.png";
import custom_smartphone_128gb from "./custom_smartphone_128gb.png";
...
export const assets = {
  ...
  custom_yoga_mat,
  custom_dumbbell,
  custom_cycling_helmet,
  custom_badminton_racket,
  custom_water_bottle,
  custom_speaker,
  custom_headphones,
  custom_tv_42,
  custom_gaming_laptop,
  custom_smartphone_128gb,
  menu_icon,
  delivery_truck_icon,
  leaf_icon,
  coin_icon,
...
export const categories = [
  ...
  },
  {
    text: "Baby Items",
    path: "Baby",
    image: "https://images.unsplash.com/photo-1558060370-d644479cb6f7?auto=format&fit=crop&w=300&q=80",
    bgColor: "#FFFDE7",
  },
  {
    text: "Beauty & Care",
...
export const features = [
  ...
  },
  {
    ...
    description: "Top products sourced from trusted sellers.",
  },
  {
    icon: coin_icon,
    title: "Affordable Prices",
    description: "Great value across all categories.",
  },
  {
    icon: trust_icon,
...
export const electronicsProducts = [
  ...
  },
  {
    ...
    description: [
      ...
      "Built-in streaming apps and smart remote",
      "Slim bezel design for modern rooms",
    ],
    inStock: true,
  },
  {
    ...
    price: 1850,
    offerPrice: 1350,
    image: [custom_speaker],
    description: [
      "Rich stereo sound with bass boost",
  ...
  },
  {
    ...
    price: 135000,
    offerPrice: 117000,
    image: [custom_gaming_laptop],
    description: [
      "High-performance processor for gaming",
      "Fast SSD storage and crisp display",
      "RGB keyboard and advanced cooling",
    ],
    inStock: true,
  },
  {
    ...
    price: 39999,
    offerPrice: 34999,
    image: [custom_smartphone_128gb],
    description: [
      "Crystal-clear display and fast performance",
      "Dual camera system for sharp photos",
...
export const dummyProducts = [
  ...
  },
  {
    ...
    price: 5999,
    offerPrice: 4299,
    image: [custom_dumbbell],
    description: [
      "Cast iron with rubber grip",
  ...
  },
  {
    ...
    price: 1499,
    offerPrice: 999,
    image: [custom_badminton_racket],
    description: [
      "2 rackets + 3 shuttlecocks",
      "Aluminium frame",
      "Includes carry bag",
    ],
    createdAt: "2025-03-25T07:17:46.018Z",
